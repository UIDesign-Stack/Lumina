...
function validate() {
  Object.keys(errors).forEach((k) => delete errors[k])
  if (!form.nama) errors.nama = 'Nama anggaran wajib diisi'
  if (!form.kategori) errors.kategori = 'Kategori wajib dipilih'
  if (!form.departemen) errors.departemen = 'Departemen/divisi wajib diisi'
  ...
  if (!form.jumlahAnggaran || Number(form.jumlahAnggaran) <= 0) errors.jumlahAnggaran = 'Jumlah anggaran wajib diisi dan lebih dari 0'
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div>
                <h2 class="text-lg font-semibold" :class="isDark ? 'text-white' : 'text-gray-900'">Buat Anggaran Baru</h2>
                <p class="text-xs mt-0.5" :class="isDark ? 'text-gray-400' : 'text-gray-500'">Alokasikan anggaran untuk kategori atau departemen tertentu.</p>
              </div>
              <button
                type="button"
            ...
            <form @submit.prevent="handleSubmit" class="px-6 py-5 space-y-5">
              ...
              <div>
                ...
                <input
                  v-model="form.nama"
                  type="text"
                  placeholder="Contoh: Anggaran Marketing Q3 2026"
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p v-if="errors.departemen" class="text-xs text-rose-500 mt-1">{{ errors.departemen }}</p>
                </div>
                ...
                <div>
                  <label class="block text-sm font-medium mb-1.5" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
                    Berlaku Mulai <span class="text-rose-500">*</span>
                  </label>
                  <input
                ...
                <div>
                  <label class="block text-sm font-medium mb-1.5" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
                    Jumlah Anggaran <span class="text-rose-500">*</span>
                  </label>
                  <div class="relative">
                    <span
                  ...
                  <p v-if="errors.jumlahAnggaran" class="text-xs text-rose-500 mt-1">{{ errors.jumlahAnggaran }}</p>
                </div>
                ...
                <div>
                  ...
                  <p class="text-xs mt-1" :class="isDark ? 'text-gray-500' : 'text-gray-400'">
                    Sistem akan mengirim peringatan saat realisasi mencapai persentase ini.
                  </p>
                </div>
              </div>
