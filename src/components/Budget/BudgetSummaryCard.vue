<script setup>
import { BanknotesIcon, ChartBarIcon, ChartPieIcon, ArrowTrendingUpIcon, CheckCircleIcon, CurrencyDollarIcon, ClockIcon, FolderIcon, UsersIcon, ArrowDownIcon, ArrowUpIcon, ScaleIcon, ShieldCheckIcon, ArrowsRightLeftIcon } from '@heroicons/vue/24/outline'
...
const iconMap = { wallet: BanknotesIcon, chart: ChartBarIcon, pie: ChartPieIcon, trend: ArrowTrendingUpIcon, check: CheckCircleIcon, dollar: CurrencyDollarIcon, clock: ClockIcon, folder: FolderIcon, users: UsersIcon, arrowDown: ArrowDownIcon, arrowUp: ArrowUpIcon, scale: ScaleIcon, shield: ShieldCheckIcon, exchange: ArrowsRightLeftIcon }
const colorMap = {
