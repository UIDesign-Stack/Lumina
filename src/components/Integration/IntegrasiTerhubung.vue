  ...
  <DashboardLayout :unread-notifications="1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div class="lg:col-span-2 space-y-4">
        ...
        <p v-if="connected.length === 0 && actionNeeded.length === 0" class="text-sm text-center py-8" :class="isDark ? 'text-gray-500' : 'text-gray-400'">
          Belum ada integrasi yang terhubung.
        </p>
      </div>
