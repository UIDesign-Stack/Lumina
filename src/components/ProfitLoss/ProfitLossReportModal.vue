...
function emptyForm() {
  return {
    ...
    sertakanGrafikTren: true,
    sertakanStrukturBeban: true,
    catatan: '',
  }
}
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div>
                <h2 class="text-lg font-semibold" :class="isDark ? 'text-white' : 'text-gray-900'">Buat Laporan Laba Rugi</h2>
                <p class="text-xs mt-0.5" :class="isDark ? 'text-gray-400' : 'text-gray-500'">Susun laporan laba rugi custom untuk periode yang kamu pilih.</p>
              </div>
              <button
                type="button"
            ...
            <form @submit.prevent="handleSubmit" class="px-6 py-5 space-y-5">
              ...
              <div>
                ...
                <input
                  v-model="form.nama"
                  type="text"
                  placeholder="Contoh: Laporan Laba Rugi Q2 2026"
              ...
              <div>
                ...
                >
                  ...
                  <option value="ringkasan">Ringkasan Laba Rugi</option>
                  <option value="per_departemen">Detail per Departemen</option>
              ...
              <div>
                ...
                <div class="space-y-2.5">
                  <label class="flex items-center gap-2.5 text-sm cursor-pointer" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
                    ...
                    Sertakan ringkasan laba rugi
                  </label>
                  <label class="flex items-center gap-2.5 text-sm cursor-pointer" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
                    <input v-model="form.sertakanGrafikTren" type="checkbox" class="w-4 h-4 rounded accent-purple-600" />
                    Sertakan grafik tren
                  </label>
                  <label class="flex items-center gap-2.5 text-sm cursor-pointer" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
                    <input v-model="form.sertakanStrukturBeban" type="checkbox" class="w-4 h-4 rounded accent-purple-600" />
                    Sertakan struktur beban per departemen
                  </label>
                  <label class="flex items-center gap-2.5 text-sm cursor-pointer" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
