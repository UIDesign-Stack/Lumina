...
function validate() {
  ...
  if (!form.jenis) errors.jenis = 'Jenis laporan wajib dipilih'
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div>
                <h2 class="text-lg font-semibold" :class="isDark ? 'text-white' : 'text-gray-900'">Buat Laporan Baru</h2>
                <p class="text-xs mt-0.5" :class="isDark ? 'text-gray-400' : 'text-gray-500'">Susun laporan keuangan untuk periode yang kamu pilih.</p>
              </div>
              <button
                type="button"
            ...
            <form @submit.prevent="handleSubmit" class="px-6 py-5 space-y-5">
              ...
              <div>
                ...
                <input
                  v-model="form.nama"
                  type="text"
                  placeholder="Contoh: Laporan Laba Rugi Mei 2026"
              ...
              <div>
                ...
                >
                  ...
                  <option value="perubahan_modal">Laporan Perubahan Modal</option>
                  <option value="kustom">Laporan Kustom</option>
                </select>
                <p v-if="errors.jenis" class="text-xs text-rose-500 mt-1">{{ errors.jenis }}</p>
              </div>
              ...
              <div>
                ...
                <div class="space-y-2.5">
                  ...
                  <label class="flex items-center gap-2.5 text-sm cursor-pointer" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
                    <input v-model="form.sertakanGrafik" type="checkbox" class="w-4 h-4 rounded accent-purple-600" />
                    Sertakan grafik dan visualisasi tren
                  </label>
                  <label class="flex items-center gap-2.5 text-sm cursor-pointer" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
                    <input v-model="form.sertakanDetailTransaksi" type="checkbox" class="w-4 h-4 rounded accent-purple-600" />
                    Sertakan detail per transaksi
                  </label>
                  <label class="flex items-center gap-2.5 text-sm cursor-pointer" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
